                    ...
                    <div className="relative pl-8 border-l-2 border-dashed border-stone-200 dark:border-stone-700 space-y-10">
                        {analysis.phases?.map((phase, i) => (
                            <div key={i} className="relative">
                                {/* Dot */}
                                <div className={`absolute -left-[41px] top-1 w-6 h-6 rounded-full border-4 border-white dark:border-stone-900 ${
                        ...
                        <div className="flex flex-wrap gap-2">
                            {analysis.dominantTopics?.map((t, i) => (
                                <motion.span whileHover={{ scale: 1.05 }} key={i} className={`px-4 py-2 rounded-xl text-xs font-medium cursor-default border ${
                                    t.category === 'deep' ? 'bg-purple-50 dark:bg-purple-900/20 border-purple-100 text-purple-600 dark:text-purple-300' :
                             ...
                             <div className="bg-stone-50 dark:bg-stone-800 p-6 rounded-3xl border border-stone-200 dark:border-stone-700">
                                ...
                                <div className="space-y-2">
                                    {evidenceMessages.map((msg, i) => (
                                        <div key={i} className={`p-3 rounded-xl text-xs max-w-[85%] shadow-sm border border-stone-100 dark:border-stone-700 ${
                                            i % 2 === 0 
